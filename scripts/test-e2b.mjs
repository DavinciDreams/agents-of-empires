...
async function testE2BIntegration() {
  ...
  try {
    ...
    const execution = await sandbox.notebook.execCell("print('Hello from Python!')\nresult = 2 + 2\nresult");
    ...
    const fileOps = await sandbox.notebook.execCell(`
